...
class RolloutBuffer(BaseBuffer):
    ...
    def compute_returns_nstep(self, last_values: th.Tensor, dones: np.ndarray) -> None:
        """
        Uses the advantage function estimate A^pi(s,a) but using n_steps as opposed to just one.
        ...
        for step in reversed(range(self.buffer_size)):
            ...
            delta = self.rewards[step] + self.gamma * delta * (next_non_terminal+next_values)
